  ...
  <!-- About Start -->
    <div class="container-fluid">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-5">
                    <img class="img-fluid rounded" src="<?php echo base_url();?>img/about2.jpg" alt="">
                </div>
               
                <div class="col-lg-7">
                  
                    <h4 class="text-uppercase">Specialist Immigration Solicitors</h4>
                    <p align="left">Specialist immigration solicitors are legal professionals who can help you with various immigration matters, such as Immigration Appeals,Judicial review,Court of Appeal.
                    Specialist immigration solicitors have the expertise and experience to provide you with the best immigration service. They are trusted by businesses and individuals for their immigration needs. They keep up-to-date with the changes in the immigration law and provide timely service without delay.</p>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    ...
                    Immigration lawyers can be found through various sources, such as the Office of the Immigration Services Commissioner (OISC) Adviser Finder, the Law Society, UK Immigration Solicitors, UK Immigration Lawyers, and the Immigration Law Practitioners’ Association (ILPA).
</p>
                    <!--<a href="" class="btn btn-primary mt-2">Learn More</a>-->
                </div>
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel team-carousel position-relative" style="margin-top: -97px; padding: 0 30px;">
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            <h5 class="mb-2 px-4">James</h5>
                            <p class="mb-3 px-4">Shipping Law</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="<?php echo base_url();?>img/t1.jpg" alt="">
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            <h5 class="mb-2 px-4">Evelyn</h5>
                            <p class="mb-3 px-4">Tax Law</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="<?php echo base_url();?>img/t2.jpg" alt="">
                                <div class="team-social">
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            <h5 class="mb-2 px-4">Charles</h5>
                            <p class="mb-3 px-4">Charity Law</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="<?php echo base_url();?>img/t3.jpg" alt="">
                                <div class="team-social">
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            <h5 class="mb-2 px-4">William</h5>
                            <p class="mb-3 px-4">Property Law</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="<?php echo base_url();?>img/t4.jpg" alt="">
                                <div class="team-social">
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            <h5 class="mb-2 px-4">Oliver</h5>
                            <p class="mb-3 px-4">Human Rights Law</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="<?php echo base_url();?>img/t5.jpg" alt="">
                                <div class="team-social">
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-4">
                        <p style="hyphens: auto;align:left">Great service and friendly staff.They were very professional,knowledgeable and helpful. They answered all my questions and guided me through the process.</p>
                    </div>
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo base_url();?>img/testimonial-1.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Jozzby.com</h5>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-4">
                        <p style="hyphens: auto;align:left">Very helpful and reassuring.He was very honest and gave me clear advice.He also followed up with me by email and phone.He is a great immigration lawyer</p>
                    </div>
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo base_url();?>img/testimonial-2.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Daniry.com</h5>
                            <p class="m-0">Client</p>
                        </div>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-4">
                        <p style="hyphens: auto;align:left">Excellent and efficient.They prepared all the documents and filed them on time. They also kept me updated on the status of my application.They are the best immigration attorneys.</p>
                    </div>
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo base_url();?>img/testimonial-3.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Hamofy.com</h5>
                            <p class="m-0">Client</p>
                        </div>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-4">
                        <p style="hyphens: auto;align:left">Knowledgeable and kind.She was very friendly and patient. She explained everything to me in detail and made sure I understood. I passed with flying colors and became a US citizen.</p>
                    </div>
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo base_url();?>img/testimonial-4.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Honoly.com</h5>
                            <p class="m-0">Client</p>
                        </div>
