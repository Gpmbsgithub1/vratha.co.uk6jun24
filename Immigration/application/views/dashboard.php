        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    ...
                    <p>Immigration lawyers can help clients with various immigration matters, such as visa applications, permanent residency, naturalisation, citizenship, immigration appeals, administrative reviews, judicial reviews, and business immigration1.
                    ...
                    <div class="feature-text bg-white rounded p-lg-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="m-0">Who specialize in different areas of immigration law, such as visa applications, citizenship, asylum, deportation, and more. They have the knowledge and skills to handle complex and challenging immigration cases and provide you with the best possible advice and representation.</p>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="btn-primary btn-lg-square px-3" style="border-radius: 50px;">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="m-0">Who can provide you with personalized and comprehensive service that meets your specific needs and goals. They can assess your situation, evaluate your options, and guide you through the entire immigration process.</p>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="btn-primary btn-lg-square px-3" style="border-radius: 50px;">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="m-0">Immigration lawyers in the UK have a track record of success and reputation in the immigration field. They have helped thousands of clients achieve their immigration objectives and overcome various immigration challenges. They have also received positive reviews and ratings from their previous clients and peers. </p>
                            </div>
                        </div>
                    </div>
                </div>
